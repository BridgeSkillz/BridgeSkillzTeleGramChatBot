...
from bridge_skillz_gpt.components.vector_store.batched_chroma import BatchedChromaVectorStore
from bridge_skillz_gpt.open_ai.extensions.context_filter import ContextFilter
from bridge_skillz_gpt.paths import local_data_path
            ...
            case "chroma":
                try:
                    ...
                    raise ImportError(
                        ...
                        "To use BridgeSkillzGpt with Chroma, install the 'chroma' extra."
