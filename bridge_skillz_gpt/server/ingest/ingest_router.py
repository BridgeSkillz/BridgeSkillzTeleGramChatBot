...
from bridge_skillz_gpt.server.ingest.ingest_service import IngestService
...
def ingest_file(request: Request, file: UploadFile) -> IngestResponse:
    ...
    return IngestResponse(object="list", model="bridge-skillz-gpt", data=ingested_documents)
